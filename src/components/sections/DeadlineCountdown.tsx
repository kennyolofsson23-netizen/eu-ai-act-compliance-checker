...
export default function DeadlineCountdown() {
  ...
  return (
    <section className="py-20 md:py-32 bg-white" aria-labelledby="deadlines-heading">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 id="deadlines-heading" className="text-4xl font-bold text-slate-900">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-2">
                      {deadline.articles.map(a => (
                        <span key={a} className="text-xs bg-white border border-slate-200 text-slate-600 px-2 py-0.5 rounded">
                          {a}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="text-right shrink-0">
                    ...
                    {mounted && (
                      <div className={`text-2xl font-bold mt-1 ${
                        isPast ? 'text-green-700' : isUrgent ? 'text-orange-700' : 'text-blue-700'
                      }`}>
