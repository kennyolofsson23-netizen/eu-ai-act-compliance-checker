...
export const APP_URL = process.env.NEXT_PUBLIC_APP_URL || 'https://euaiacompliance.app'
export const APP_DESCRIPTION = 'Free AI risk classification tool for EU AI Act compliance. Get your risk level, obligation checklist, and shareable compliance badge in 3 minutes.'
...
export const EU_AI_ACT_DEADLINES = [
  {
    ...
    description: 'AI systems in the prohibited category must be withdrawn immediately.',
    articles: ['Article 5'],
  },
  {
    id: 'gpai',
    ...
    description: 'General Purpose AI model providers must comply with obligations.',
  ...
  },
  {
    ...
    description: 'Full enforcement of high-risk AI obligations including technical documentation, conformity assessment, and registration.',
    articles: ['Article 6', 'Article 9-15', 'Article 43', 'Article 49', 'Article 72'],
  },
  {
    id: 'transparency',
    date: '2026-08-02',
    title: 'Transparency Obligations',
    description: 'Limited risk AI systems must comply with transparency and disclosure requirements.',
    articles: ['Article 50'],
  },
]
