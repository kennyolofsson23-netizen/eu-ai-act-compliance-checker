...
export async function POST(request: NextRequest) {
  try {
    ...
    const rl = rateLimit(
      ...
      userId ? RATE_LIMITS.ASSESSMENT_CREATE_AUTH.limit : RATE_LIMITS.ASSESSMENT_CREATE_ANON.limit,
      userId ? RATE_LIMITS.ASSESSMENT_CREATE_AUTH.windowMs : RATE_LIMITS.ASSESSMENT_CREATE_ANON.windowMs
    )
